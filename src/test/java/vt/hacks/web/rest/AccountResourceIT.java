...
import vt.hacks.VtFoodApp;
import vt.hacks.config.Constants;
import vt.hacks.domain.PersistentToken;
import vt.hacks.domain.User;
import vt.hacks.repository.AuthorityRepository;
import vt.hacks.repository.PersistentTokenRepository;
import vt.hacks.repository.UserRepository;
import vt.hacks.security.AuthoritiesConstants;
import vt.hacks.service.UserService;
import vt.hacks.service.dto.PasswordChangeDTO;
import vt.hacks.service.dto.UserDTO;
import vt.hacks.web.rest.vm.KeyAndPasswordVM;
import vt.hacks.web.rest.vm.ManagedUserVM;
...
import static vt.hacks.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = VtFoodApp.class)
