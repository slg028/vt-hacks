...
import vt.hacks.config.audit.AuditEventConverter;
import vt.hacks.domain.PersistentAuditEvent;
...
import static vt.hacks.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
